...
"        float weightSum = 0.0;\n"
"        for(int j = 0; j < k; j++) {\n"
"            vec3 position = vec3(textureLod(nodeSampler, vec2(((nearNodes[j] * 16.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((nearNodes[j] * 16.0 + 1.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((nearNodes[j] * 16.0 + 2.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
...
"        for(int i = 0; i < k; i++) {\n"
"            vec3 position = vec3(textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 1.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 2.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"            vec3 column0 = vec3(textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 3.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 4.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x,\n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 5.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"            vec3 column1 = vec3(textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 6.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 7.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x,\n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 8.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"            vec3 column2 = vec3(textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 9.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 10.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x,\n"
"                                textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 11.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"            mat3 rotation = mat3(column0, column1, column2);\n"
"            vec3 translation = vec3(textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 12.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                    textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 13.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x,\n"
"                                    textureLod(nodeSampler, vec2(((nearNodes[i] * 16.0 + 14.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
...
"            if(localPos.z > 0.0 && localPos.z < maxDepth && x > 0 && y > 0 && x < cols && y < rows) {\n"
