...
"        while(imax >= imin) {\n"
"            imid = (imin + imax) / 2;\n"
"            int nodeTime = int(textureLod(nodeSampler, vec2(((imid * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
...
"        int nodeMin = int(textureLod(nodeSampler, vec2(((imin * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x);\n"
"        int nodeMid = int(textureLod(nodeSampler, vec2(((imid * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x);\n"
"        int nodeMax = int(textureLod(nodeSampler, vec2(((imax * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x);\n"
