...
"        int nodeMin = int(textureLod(nodeSampler, vec2(((floatimin) * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"        int nodeMid = int(textureLod(nodeSampler, vec2(((floatimid) * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
"        int nodeMax = int(textureLod(nodeSampler, vec2(((floatimax) * 16.0 + 15.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
...
"            vec3 position = vec3(textureLod(nodeSampler, vec2(((j * 16.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((j * 16.0 + 1.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((j * 16.0 + 2.0) / nodeCols) + (1.0 / (nodeCols * 2.0)), 0.5), 0.0).x);\n"
