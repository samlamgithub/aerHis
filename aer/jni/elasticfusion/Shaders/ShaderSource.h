...
"            vec3 position = vec3(textureLod(nodeSampler, vec2(((float(j) * 16.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((float(j) * 16.0 + 1.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x, \n"
"                                 textureLod(nodeSampler, vec2(((float(j) * 16.0 + 2.0) / nodeCols) + (1.0 / (nodeCols * 2)), 0.5), 0.0).x);\n"
"            nearNodes[nearNodeIndex] = j;\n"
"            nearDists[nearNodeIndex] = sqrt(dot(vPosition.xyz - position, vPosition.xyz - position));\n"
"            nearNodeIndex++;\n"
