...
// FRAMEBUFFER
//
// typedef void(GL_API_CALL_P PFNGLDEBUGMESSAGECONTROLPROCKHR)(
...
//
// typedef void(GL_API_CALL_P PFNGLDEBUGMESSAGECALLBACKPROCKHR)(
//     GLDEBUGPROCKHR callback, const void *userParam);
// extern PFNGLDEBUGMESSAGECALLBACKPROCKHR glDebugMessageCallback;
//
// typedef void(GL_API_CALL_P PFNGLPUSHDEBUGGROUPPROCKHR)(GLenum source, GLuint id,
//                                                        GLsizei length,
//                                                        const GLchar *message);
...
//
// typedef void(GL_API_CALL_P PFNGLOBJECTLABELPROCKHR)(GLenum identifier,
...
// #endif
//
// typedef GLint(GL_API_CALL_P PFNGLGETVARYINGLOCATIONNVPROC)(GLuint program,
//                                                            const GLchar *name);
// extern PFNGLGETVARYINGLOCATIONNVPROC glGetVaryingLocationNV;
//
// typedef void(GL_API_CALL_P PFNGLTRANSFORMFEEDBACKVARYINGSNVPROC)(
...
//
// typedef void(GL_API_CALL_P PFNGLGETBUFFERSUBDATAPROC)(GLenum target,
//                                                       GLintptr offset,
//                                                       GLsizeiptr size,
//                                                       void *data);
...
//
// typedef void(GL_API_CALL_P PFNGLTEXBUFFEROESPROC)(GLenum target,
//                                                   GLenum internalformat,
//                                                   GLuint buffer);
// extern PFNGLTEXBUFFEROESPROC glTexBufferOES;
//
// typedef void(GL_API_CALL_P PFNGLTEXBUFFERRANGEOESPROC)(GLenum target,
//                                                        GLenum internalformat,
//                                                        GLuint buffer,
//                                                        GLintptr offset,
//                                                        GLsizeiptr size);
...
//
// typedef void(GL_API_CALL_P PFNGLTEXBUFFEREXTPROC)(GLenum target,
//                                                   GLenum internalformat,
//                                                   GLuint buffer);
// extern PFNGLTEXBUFFEREXTPROC glTexBufferEXT;
//
// typedef void(GL_API_CALL_P PFNGLTEXBUFFERRANGEEXTPROC)(GLenum target,
//                                                        GLenum internalformat,
//                                                        GLuint buffer,
//                                                        GLintptr offset,
//                                                        GLsizeiptr size);
...
//
// typedef void(GL_API_CALL_P PFNGLDISPATCHCOMPUTEPROC)(GLuint num_groups_x,
//                                                      GLuint num_groups_y,
//                                                      GLuint num_groups_z);
// extern PFNGLDISPATCHCOMPUTEPROC glDispatchCompute30;
//
// typedef void(GL_API_CALL_P PFNGLBINDIMAGETEXTUREPROC)(
...
// typedef void(GL_API_CALL_P PFNGLFRAMEBUFFERTEXTUREPROC)(GLenum target,
//                                                         GLenum attachment,
//                                                         GLuint texture,
//                                                         GLint level);
// extern PFNGLFRAMEBUFFERTEXTUREPROC glFramebufferTexture;
//
// typedef void(GL_API_CALL_P PFNGLGETTEXLEVELPARAMETERIVPROC)(GLenum target,
//                                                             GLint level,
//                                                             GLenum pname,
//                                                             GLint *params);
...
//
// typedef void(GL_API_CALL_P PFNGLGETQUERYOBJECTI64VPROC)(GLuint id,
//                                                         GLenum target,
//                                                         GLint64 *params);
// extern PFNGLGETQUERYOBJECTI64VPROC glGetQueryObjecti64vEXT;
//
// typedef void(GL_API_CALL_P PFNGLGETQUERYOBJECTUI64VPROC)(GLuint id,
//                                                          GLenum target,
//                                                          GLuint64 *params);
...
// typedef void(GL_API_CALL_P PFNGLTEXTUREVIEWPROC)(
