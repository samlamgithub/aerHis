...
//
//            icpStepMap["GeForce GTX 980 Ti"] = std::pair<int, int>(128, 176);
//            rgbStepMap["GeForce GTX 980 Ti"] = std::pair<int, int>(240, 64);
//            rgbResMap["GeForce GTX 980 Ti"] = std::pair<int, int>(256, 176);
//            so3StepMap["GeForce GTX 980 Ti"] = std::pair<int, int>(320, 32);
//
//
