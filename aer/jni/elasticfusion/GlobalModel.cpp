...
LOGI("MY elasitcfusion GlobalModel struct init check 6 ");
    glTransformFeedbackVaryings(dataProgram->programId(), 3, vars, GL_INTERLEAVED_ATTRIBS);
...
LOGI("MY elasitcfusion GlobalModel struct init check 6  4");
   glTransformFeedbackVaryings(unstableProgram->programId(), 3, vars, GL_INTERLEAVED_ATTRIBS);
...
LOGI("MY elasitcfusion GlobalModel struct init check 6  8");
    glTransformFeedbackVaryings(initProgram->programId(), 3, vars, GL_INTERLEAVED_ATTRIBS);
