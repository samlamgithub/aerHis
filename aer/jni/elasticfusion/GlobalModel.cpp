...
GlobalModel::GlobalModel()
 : target(0),
   ...
   count(0),
   initProgram(loadProgram(init_unstablevert)),
   drawProgram(loadProgram(draw_feedbackvert, draw_feedbackfrag)),
   drawSurfelProgram(loadProgram(draw_global_surfacevert, draw_global_surfacefrag, draw_global_surfacegeom)),
   dataProgram(loadProgram(datavert, datafrag, datageom)),
   updateProgram(loadProgram(updatevert)),
   unstableProgram(loadProgramGeom(copy_unstablevert, copy_unstablegeom)),
