...
class ElasticFusion {
public:
  ElasticFusion(const int timeDelta = 200, const int countThresh = 35000,
   ...
   * [vertex/normal/image]Tex() members of the indexMap class
   */
  void predict();
   ...
   * OpenGL texture (this is stored under textures[GPUTexture::DEPTH_NORM]
