...
//
// bool GuiInterface::display_marker_data(const std::vector<MarkerData>&
// marker_data) {
//  for (auto marker : marker_data) {
//      tango_interface::GuiInterface::add_marker(marker.id,
//            marker.estimated_raw_corners(0,0),
//            marker.estimated_raw_corners(1,0),
//            marker.estimated_raw_corners(0,1),
//            marker.estimated_raw_corners(1,1),
//            marker.estimated_raw_corners(0,2),
//            marker.estimated_raw_corners(1,2),
//            marker.estimated_raw_corners(0,3),
//            marker.estimated_raw_corners(1,3));
//  }
//}
//
...
//  jmethodID marker_overlay_ref = env->GetMethodID(gui_class, "addMarker",
//  "(IIIIIIIII)V"); env->CallVoidMethod(gui_ref_, marker_overlay_ref,
//  label_id,x1,y1,x2,y2,x3,y3,x4,y4); env->DeleteLocalRef(gui_class); return
//  true;
//}
