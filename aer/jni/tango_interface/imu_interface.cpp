...
//    sensor_event_queue_ = ASensorManager_createEventQueue(sensor_manager,
//    looper,
...
//    ASensorEventQueue_setEventRate(sensor_event_queue_, acc_sensor,
//    acc_min_delay); ASensorEventQueue_setEventRate(sensor_event_queue_,
//    gyro_sensor, gyro_min_delay); sensor_initialised_ = true;
//  }
...
//}
//
// void ImuInterface::register_accelerometer_callback(AccelerometerCallBack
// function) {
...
//  ASensorEvent event;
//  while (!pause_callbacks_ && ASensorEventQueue_getEvents(sensor_event_queue_,
//  &event, 1) > 0) {
